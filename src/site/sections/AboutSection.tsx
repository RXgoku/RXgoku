...
import { ABOUT_TEXT, DECOR } from '../data'
...
export default function AboutSection() {
  return (
    ...
    >
      ...
      >
        <img src={DECOR.moon} alt="" className="w-full" />
      </FadeIn>
      ...
      >
        <img src={DECOR.object} alt="" className="w-full" />
      </FadeIn>
      ...
      >
        <img src={DECOR.lego} alt="" className="w-full" />
      </FadeIn>
      ...
      >
        <img src={DECOR.group} alt="" className="w-full" />
      </FadeIn>
      ...
      <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24">
        <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16">
          <FadeIn
            ...
            delay={0}
            y={40}
            className="display-heading text-center font-black uppercase leading-none tracking-tight"
