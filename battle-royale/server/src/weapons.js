...
export const WEAPONS = {
  pistol: {
    label: "Pistol", color: "#bdc3c7", damage: 18, cooldownMs: 300, spread: 0.04, pellets: 1,
    bulletSpeed: 900, rangeMs: 600, magSize: 12, reloadMs: 1000, reserve: Infinity, barrel: 8,
  },
  smg: {
    label: "SMG", color: "#3498db", damage: 12, cooldownMs: 90, spread: 0.10, pellets: 1,
    bulletSpeed: 950, rangeMs: 550, magSize: 30, reloadMs: 1600, reserve: 90, spawnWeight: 4, barrel: 12,
  },
  shotgun: {
    label: "Shotgun", color: "#e67e22", damage: 10, cooldownMs: 800, spread: 0.30, pellets: 7,
    bulletSpeed: 800, rangeMs: 300, magSize: 5, reloadMs: 2200, reserve: 15, spawnWeight: 3, barrel: 14,
  },
  sniper: {
    label: "Sniper", color: "#9b59b6", damage: 90, cooldownMs: 1200, spread: 0.005, pellets: 1,
